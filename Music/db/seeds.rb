...
drake = Artist.create(name: "Drake", image:"https://www.buymixtapes.com/upload/members/images/backtoback.jpg")
big = Artist.create(name: "Big Shaq", image:"https://el-nation.com/data/50ce25bfb5a41c5219ae93d9e16c6d32.jpg")
phyno = Artist.create(name: "Phyno", image:"https://is2-ssl.mzstatic.com/image/thumb/Music125/v4/85/51/d2/8551d2f0-bfa4-1578-9621-ff4cf71059be/source/1200x1200bb.jpg")
skepta = Artist.create(name: "Skepta", image:"https://upload.wikimedia.org/wikipedia/en/0/08/Konnichiwa_by_Skepta_cover.jpg")
